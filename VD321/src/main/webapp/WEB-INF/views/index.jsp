...
<html lang="en">
    <head>
		...
		<link href="<c:url value='https://fonts.googleapis.com/css2?family=Inter:wght@100;300;400;700;900&display=swap'/>" rel="stylesheet">
		<link href="<c:url value='/resources/css/bootstrap.min.css'/>" rel="stylesheet">
		<link href="<c:url value='/resources/css/bootstrap-icons.css'/>" rel="stylesheet">
		<link rel="stylesheet" href="<c:url value='/resources/css/slick.css'/>"/>
		<link href="<c:url value='/resources/css/tooplate-little-fashion.css'/>" rel="stylesheet">
    ...
    <body>
        ...
        <main>
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            <li class="nav-item">
                                <a class="nav-link active" href="/VD321/home/index">Home</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="/VD321/home/about">Story</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="/VD321/home/feedback">Feedback</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="/VD321/home/faq">FAQs</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link" href="/VD321/home/contact">Contact</a>
                            </li>
                        </ul>
            ...
            <section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="<c:url value="/resources/images/slideshow/medium-shot-business-women-high-five.jpeg"/>" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="<c:url value="/resources/images/slideshow/team-meeting-renewable-energy-project.jpeg"/>" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="feedback" class="btn custom-btn">Explore products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slick-custom">
                    <img src="<c:url value="/resources/images/slideshow/two-business-partners-working-together-office-computer.jpeg"/>" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="<c:url value="/resources/images/pim-chu-z6NZ76_UTDI-unsplash.jpeg"/>" class="img-fluid" alt="">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <div class="ratio ratio-16x9">
                                                <iframe src="<c:url value="https://www.youtube-nocookie.com/embed/f_7JqPDWhfw?controls=0"/>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="<c:url value="/resources/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg"/>" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <div class="mt-2 mt-lg-auto">
                                                    <a href="feedback" class="custom-link mb-2">
                                                        Explore products
                                                        <i class="bi-arrow-right ms-2"></i>
                                                    </a>
                                                </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="<c:url value="/resources/images/retail-shop-owner-mask-social-distancing-shopping.jpg"/>" class="img-fluid" alt="">
                        </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="<c:url value="/resources/images/product/evan-mcdougall-qnh1odlqOmk-unsplash.jpeg"/>" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="<c:url value="/resources/images/product/jordan-nix-CkCUvwMXAac-unsplash.jpeg"/>" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="<c:url value="/resources/images/product/nature-zen-3Dn1BZZv3m8-unsplash.jpeg"/>" class="img-fluid product-image" alt="">
                                </a>
                        ...
                        <div class="col-12 text-center">
                            <a href="feedback" class="view-all">View All Products</a>
                        </div>
	    ...
	    <script src="<c:url value='/resources/js/Headroom.js'/>"></script>
	    <script src="<c:url value='/resources/js/jQuery.headroom.js'/>"></script>
